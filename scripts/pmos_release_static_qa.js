...
function main() {
  ...
  assert(pmosSw.includes("pmos-cache-v8"), 'scoped PMOS service worker must use pmos-cache-v8');
  assert(rootPmosSw.includes("pmos-cache-v8"), 'legacy PMOS service worker must use pmos-cache-v8');
