...
function main() {
  ...
  assert(sw.includes("const CACHE_NAME = 'acpm-v146'"), 'service worker cache must be acpm-v146');
  ...
  assert(JSON.stringify(baselineStyles) === JSON.stringify(['style.css?v=114', 'assets/brand/ai-command-center.css?v=4']), 'dashboard.html must include current versioned styles');
