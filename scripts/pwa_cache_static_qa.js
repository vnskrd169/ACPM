...
function main() {
  ...
  assert(sw.includes("const CACHE_NAME = 'acpm-v139'"), 'service worker cache must be acpm-v139');
  ...
  assert(JSON.stringify(baselineStyles) === JSON.stringify(['style.css?v=112']), 'dashboard.html must include versioned style.css?v=112');
