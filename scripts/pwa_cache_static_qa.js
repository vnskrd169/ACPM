...
function main() {
  ...
  assert(sw.includes("const CACHE_NAME = 'acpm-v152'"), 'service worker cache must be acpm-v152');
  ...
  assert(JSON.stringify(baselineStyles) === JSON.stringify(['style.css?v=114', 'materials-workspace.css?v=1', 'assets/brand/ai-command-center.css?v=7']), 'dashboard.html must include current versioned styles');
