...
const ASSETS = [
  ...
  './labor.js?v=101',
  './materials.js?v=100',
  './materials-workspace.js?v=3',
  './workspace-insights.js?v=2',
  './project-controls.js?v=1',
  './project-controls.css?v=1',
  './workspace-insights.css?v=1',
  './materials-workspace.css?v=2',
  './billing.js?v=76',
